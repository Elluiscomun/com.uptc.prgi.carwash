 ...
 * @author Edwin Niño
 */
public class TestDetermineValueToPay {

    public void testsDetermineValueToPay(){
        ...
        System.out.println("CASOS DE PRUEBA: DETERMINAR EL VALOR TOTAL A PAGAR...");
        System.out.println("CASO #1:" + (sale1.determineValueToPay()==20000? "OK":"ERROR"));
        
        System.out.println("CASO #2:" + (sale2.determineValueToPay()==8000? "OK":"ERROR"));
        
        System.out.println("CASO #3:" + (sale3.determineValueToPay()==27000? "OK":"ERROR"));
        
        System.out.println("CASO #4:" + (sale4.determineValueToPay()==27000? "OK":"ERROR"));
        
        System.out.println("CASO #5:" + (sale5.determineValueToPay()==27000? "OK":"ERROR"));
        
        System.out.println("CASO #6:" + (sale6.determineValueToPay()==20000? "OK":"ERROR"));
        
        System.out.println("CASO #7:" + (sale7.determineValueToPay()==20000? "OK":"ERROR"));
    ...
    public static void main(String[] args) {
        ...
        TestDetermineValueToPay testDetermineValueToPay = new TestDetermineValueToPay();
        testDetermineValueToPay.testsDetermineValueToPay();
    }
