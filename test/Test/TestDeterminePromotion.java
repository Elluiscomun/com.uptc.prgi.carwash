 ...
 * @author Edwin Niño
 */
public class TestDeterminePromotion {

    public void testsDeterminePromotion(){
        ...
        System.out.println("CASOS DE PRUEBA: DETERMINAR QUE USUARIOS APLICAN AL DESCUENTO/PROMOCION...");
        System.out.println("CASO #1:" + (sale1.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #2:" + (sale2.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #3:" + (sale3.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #4:" + (sale4.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #5:" + (sale5.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #6:" + (sale6.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #7:" + (sale7.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #8:" + (sale8.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #9:" + (sale9.determinePromotion()? "YES":"NO"));
        
        System.out.println("CASO #10:" + (sale10.determinePromotion()? "YES":"NO"));
    }
    
    
    public static void main(String[] args) {
        
        TestDeterminePromotion testDeterminePromotion = new TestDeterminePromotion();
        testDeterminePromotion.testsDeterminePromotion();
    }
